...
// @version      0.1.1-test
// @description  Experimental Chrome/Tampermonkey test: replace tweet.app Explore news with Google News Japan RSS. Fast text-first version without per-article image fetching.
...
(() => {
  ...
  function install() {
    ...
    console.log('🇯🇵 Classic Twitter Japanese News Test v0.1.1 installed');
  }
